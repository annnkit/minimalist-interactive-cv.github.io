  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 pt-16 hero-pattern">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-8 relative w-48 h-48 mx-auto overflow-hidden rounded-full border-4 border-primary shadow-xl bg-gradient-to-br from-secondary to-primary/50">
          <img
            src="/placeholder.svg"
            alt="Ankit Jangir"
